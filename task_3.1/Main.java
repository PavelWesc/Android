...
gosha.about();
        ...
        System.out.println("У меня две бабушки, бабушка: "+eva.getMother().getName()+
                " и бабушка "+alex.getMother().getName());
        System.out.println("У меня два деда, дед "+alex.getFather().getName()+" " +
                "и дед "+eva.getFather().getName());
